...
const Home = () => {
  return (
    ...
    <div className="flex flex-col min-h-screen w-screen justify-center items-center bg-blue-800 p-6">
      {/* Title Section */}
      <h1 className="text-white font-kanit text-4xl md:text-6xl font-bold mb-10 text-center">
        HOW TO USE
      </h1>
      ...
      {/* Divider */}
      <div className="h-1 w-32 bg-white rounded-full my-12" />
...
const InstructionStep = ({ number, text }: InstructionStepProps) => (
  <div className="flex items-center bg-white/10 backdrop-blur-md rounded-xl p-4 shadow-md space-x-4">
    <div className="flex justify-center items-center bg-white text-blue-800 font-bold rounded-full w-10 h-10">
      {number}
    </div>
    <div className="text-white font-kanit text-lg">
      {text}
    </div>
  </div>
);
