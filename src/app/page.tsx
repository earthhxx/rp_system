...
const Home = () => {
    return (
        ...
        <div className="flex flex-col h-screen w-screen justify-center items-center bg-blue-800">
            <div className="flex w-full h-fit text-5xl font-no font-bold justify-center items-center"> HOW TO USE </div>
            <div className="flex w-full h-fit text-7xl font-no font-bold justify-center items-center"> วิธีใช้งาน </div>
            <div className={`font-[--font-kanit] flex w-full h-fit text-7xl font-bold justify-center items-center`}> วิธีใช้งาน </div>
